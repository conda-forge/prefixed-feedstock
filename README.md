...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/prefixed-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12317&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/prefixed-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `prefixed` can be installed with:

```
conda install prefixed
```

It is possible to list all of the versions of `prefixed` available on your platform with:
